...
product2.photo.attach(io: file1, filename: "nes.png", content_type: "image/png")
product2.save!
...
product3.photo.attach(io: file1, filename: "nes.png", content_type: "image/png")
product3.save!
...
product4.photo.attach(io: file1, filename: "nes.png", content_type: "image/png")
product4.save!
...
product5.photo.attach(io: file1, filename: "nes.png", content_type: "image/png")
product5.save!
...
product6.photo.attach(io: file1, filename: "nes.png", content_type: "image/png")
product6.save!
...
product7.photo.attach(io: file1, filename: "nes.png", content_type: "image/png")
product7.save!
...
product8.photo.attach(io: file1, filename: "nes.png", content_type: "image/png")
product8.save!
...
product9.photo.attach(io: file1, filename: "nes.png", content_type: "image/png")
product9.save!
...
product10.photo.attach(io: file1, filename: "nes.png", content_type: "image/png")
product10.save!
...
product11.photo.attach(io: file1, filename: "nes.png", content_type: "image/png")
product11.save!
...
product12.photo.attach(io: file1, filename: "nes.png", content_type: "image/png")
product12.save!
